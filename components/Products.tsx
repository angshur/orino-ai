        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {products.map((p) => (
            <FadeUp key={p.name} delay={p.delay}>
              <div className="group flex flex-col h-full rounded-card border border-[rgba(26,26,26,0.08)] bg-surface p-7
                hover:border-[rgba(26,26,26,0.14)] hover:shadow-card-hover transition-all duration-200 cursor-default">
                <div className="flex h-11 w-11 items-center justify-center rounded-[14px] bg-[rgba(122,181,212,0.12)] mb-5">
                  {p.icon}
                </div>
